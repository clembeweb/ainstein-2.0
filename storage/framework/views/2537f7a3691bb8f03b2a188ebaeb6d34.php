    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <?php if(platform_logo_url()): ?>
                    <div class="mx-auto flex justify-center">
                        <img src="<?php echo e(platform_logo_url()); ?>" alt="<?php echo e(platform_name()); ?>" class="h-16 w-auto">
                    </div>
                <?php else: ?>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Access your AI content generation dashboard
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="font-medium text-amber-600 hover:text-amber-500">
                            Sign up here
                        </a>
                    </p>
                </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-<?php echo e(count($availableProviders)); ?> gap-3">
                    <?php if(in_array('google', $availableProviders)): ?>
                    ...
                    <?php if(in_array('facebook', $availableProviders)): ?>
            ...
            <div class="mt-6 border-t pt-6">
                <p class="text-center text-sm text-gray-600 mb-4">Demo Account</p>
                <form action="<?php echo e(route('login')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="email" value="demo@tenant.com">
...
</html><?php /**PATH C:\laragon\www\ainstein-3\resources\views/auth/login.blade.php ENDPATH**/ ?>
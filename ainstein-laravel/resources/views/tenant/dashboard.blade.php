            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('tenant.content.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                            View All →
                        </a>
                    </div>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ $stats['total_pages'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Pages</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ $stats['total_generations'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Generations</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ $stats['active_prompts'] ?? 0 }}</div>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-semibold text-green-600">{{ $stats['success_rate'] ?? 0 }}%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('tenant.campaigns.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                            View All →
                        </a>
                    </div>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ $campaignStats['total_campaigns'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Campaigns</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ $campaignStats['total_assets'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Assets</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-gray-900">{{ number_format($campaignStats['campaign_tokens'] ?? 0) }}</div>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-semibold text-gray-900">{{ $campaignStats['rsa_campaigns'] ?? 0 }} / {{ $campaignStats['pmax_campaigns'] ?? 0 }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-gray-600">
                                {{ number_format($tokenStats['total_tokens_used']) }} / {{ number_format($tokenStats['monthly_limit']) }}
                            </span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-blue-600 h-3 rounded-full" style="width: {{ $tokenStats['usage_percent'] ?? 0 }}%"></div>
                        </div>
                    </div>
                    <div class="grid grid-cols-3 gap-4 pt-4 border-t">
                        <div>
                            <div class="text-sm text-gray-600">Used</div>
                            <div class="text-lg font-semibold text-gray-900">{{ number_format($tokenStats['total_tokens_used']) }}</div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600">Remaining</div>
                            <div class="text-lg font-semibold text-green-600">{{ number_format($tokenStats['remaining_tokens']) }}</div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600">Limit</div>
                            <div class="text-lg font-semibold text-gray-900">{{ number_format($tokenStats['monthly_limit']) }}</div>
                        </div>
                    </div>
                </div>
            </div>

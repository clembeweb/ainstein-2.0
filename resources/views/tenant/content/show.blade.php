                    ...
                    <div class="px-6 py-4">
                        <div class="space-y-3">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $generation->content->url }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Keyword</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $generation->content->keyword ?? 'N/A' }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Content Type</dt>
                                <dd class="mt-1">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                                        {{ ucfirst($generation->content->content_type) }}
                                    </span>
                                </dd>
                            </div>
                            <div>
                                ...
                                <dd class="mt-1">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full
                                        @if($generation->content->status === 'active') bg-green-100 text-green-800
                                        @else bg-gray-100 text-gray-800 @endif">
                                        {{ ucfirst($generation->content->status) }}
                                    </span>
                                </dd>
                            </div>
                            <!--<div class="pt-3">
                                <a href="{{ route('tenant.pages.show', $generation->content) }}" class="btn-secondary w-full text-center">
                                    View Page Details
                                </a>
                            </div>-->
                            </div>

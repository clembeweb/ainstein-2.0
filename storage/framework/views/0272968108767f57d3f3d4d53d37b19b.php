...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-amber-600 px-3 py-2 text-sm font-medium transition-colors">
                        Accedi
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-amber-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-700 transition-colors">
                        Registrati
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('register')); ?>" class="bg-amber-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-amber-700 transition-colors">
                        Inizia Gratis
                    </a>
    ...
    <section class="bg-amber-600 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="bg-white text-amber-600 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-50 transition-colors">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="<?php echo e(route('api.docs')); ?>" class="hover:text-white transition-colors">API</a></li>
                    </ul>
                </div>
...
</html><?php /**PATH C:\laragon\www\ainstein-3\resources\views/landing.blade.php ENDPATH**/ ?>